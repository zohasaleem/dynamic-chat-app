...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            // 'to' => 'zohasaleem2000@gmail.com',

            // 'from' => [
            //     'address' => env('MAIL_FROM_ADDRESS', 'zohasaleem2000@gmail.com'),
            //     'name' => env('MAIL_FROM_NAME', 'Zoha Saleem'),
            // ],
        ],

        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
